...
import 'package:sipakar_water_melon/login/lupa_pass.dart';
import 'package:sipakar_water_melon/login/register.dart';
        ...
        if (res.statusCode == 200) {
          ...
          if (response['error'] != true) {
            ...
            if (tes.statusCode == 200) {
              ...
              prefs.setString('nama', responseData['nama_lengkap']);
